  ...
  if (!isOwner) {
    return (
      <div className="text-center py-12">
        ...
        <Link to="/teamhead" className="text-blue-600 underline text-sm mt-2 block">← Back</Link>
      </div>
    );
  }
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            ...
            <span className={`ml-2 text-xs px-2 py-0.5 rounded-full ${
              isAccepting ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
            }`}>
                          ...
                          {isAccepting && (
                            <>
                              ...
                              <button className="text-red-500 text-xs hover:underline"
                                onClick={() => removeFromSquad(s.squad_id)}>Remove</button>
                            </>
                          )}
                        </div>
                      </td>
