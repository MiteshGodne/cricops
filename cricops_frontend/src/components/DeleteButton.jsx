export default function DeleteButton({ children, className = '', ...props }) {
  return (
    <button className="group relative flex h-9 w-10 flex-col items-center justify-center overflow-hidden rounded-[15%] border-2 border-red-600 bg-red-600 hover:bg-red-600" {...props}>
      ...
      <svg width={10} fill="none" viewBox="0 0 39 7" className="origin-right duration-500 group-hover:rotate-90">
