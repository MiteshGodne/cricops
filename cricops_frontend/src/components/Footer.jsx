    ...
    return (
        <footer className="bg-[#183153] text-white">
            <div className="mx-auto w-full max-w-screen-xl p-4">
                <div className="md:flex m-0 md:justify-between">
                    <div className="mb-10 md:mb-0 mt-10 text-3xl flex justify-center">
                        <a href="" className="flex jusify-between items-center hover:text-[#efa800]">🏏CricOps</a>
                    </div>
                    <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-heading uppercase hover:text-[#efa800]">Resources</h2>
                            <ul className="text-body font-medium text-xs">
                                <li className="mb-4">
                                    <a href="https://cricops.vercel.app" className="hover:underline hover:text-[#efa800]">CricOps</a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline hover:text-[#efa800]">Tailwind CSS</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-heading uppercase hover:text-[#efa800]">Follow us</h2>
                            <ul className="text-body font-medium text-xs">
                                <li className="mb-4">
                                    <a href="https://github.com/miteshgodne/cricops" className="hover:underline hover:text-[#efa800] ">Github</a>
                                </li>
                                <li>
                                    <a href="https://discord.gg/miteshgodne" className="hover:underline hover:text-[#efa800]">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-heading uppercase hover:text-[#efa800]">Legal</h2>
                            <ul className="text-body font-medium text-xs ">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline hover:text-[#efa800]">Privacy Policy</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:underline hover:text-[#efa800]">Terms &amp; Conditions</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                </div>
                <hr className="my-2 border-default sm:mx-auto lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-xs text-body sm:text-center">© 2026 <a href="https://cricops.vercel.app" className="hover:underline hover:text-[#efa800]">CricOps™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="#" className="text-body hover:text-heading hover:text-[#efa800]">
                        ...
                        <a href="#" className="text-body hover:text-heading ms-5 hover:text-[#efa800]">
